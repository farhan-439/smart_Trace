...
public class ScissorsWeights {
    ...
    static Weigher<ImageEdge> makeWeigher(String weightName, ImageGraph graph) {
        return switch (weightName) {
            ...
            case "ColorWeight" -> new ColorWeight(graph);
    ...
    static Iterable<String> weightNames() {
        ...
        return List.of("CrossGradMono", "ColorWeight");
    }
    ...
    static class ColorWeight implements Weigher<ImageEdge> {
        ...
        public int weight(ImageEdge edge) {
            ...
            int eGradMax = ((edge.dir() % 2) == 0) ? 180 : 255;
            int weightRed = crossGrad(colorImage, x, y, 0, edge.dir());
            int weightGreen = crossGrad(colorImage, x, y, 1, edge.dir());
            int weightBlue = crossGrad(colorImage, x, y, 2, edge.dir());


            int maxWeight = Math.max(weightRed, Math.max(weightGreen, weightBlue));
            return eGradMax - maxWeight;
        }
    }

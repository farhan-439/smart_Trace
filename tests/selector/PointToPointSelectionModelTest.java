...
class PointToPointSelectionModelTest {
    ...
    @DisplayName("Checking Iteration Value")

    @Test
    void checkCountUpTo(){
        PointToPointSelectionModel.countUp(5);

    }


    @DisplayName("Checking Sum Value")

    @Test
    void checkSumOf(){
        int a = PointToPointSelectionModel.sumOf(10);
        int b = PointToPointSelectionModel.sumOf(0);
        assertEquals(a,55);
        assertEquals(b,0);
